...
public class DragAndDrop1 extends ItemTouchHelper.Callback {


    private ItemTouchHelperContract touchHelperContract;
    public DragAndDrop1(ItemTouchHelperContract touchHelperContract) {
    ...
    public void onSelectedChanged(@Nullable RecyclerView.ViewHolder viewHolder,
        ...
        if (actionState != ItemTouchHelper.ACTION_STATE_IDLE) {
            if (viewHolder instanceof PfAdapter.ViewHolder) {
                PfAdapter.ViewHolder myViewHolder=
                        (PfAdapter.ViewHolder) viewHolder;
    ...
    public interface ItemTouchHelperContract {
        ...
        void onRowSelected(PfAdapter.ViewHolder myViewHolder);
        void onRowClear(PfAdapter.ViewHolder myViewHolder);
